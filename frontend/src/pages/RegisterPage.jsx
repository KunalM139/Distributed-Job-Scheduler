      ...
      <div className="w-full max-w-md">
        ...
        <div className="mb-8 text-center">
          ...
          <p className="mt-1 text-sm text-surface-500 dark:text-surface-400">
            Get started with the Distributed Job Scheduler
          </p>
        </div>
        ...
        >
          <div className="space-y-4">
            <div>
              <label htmlFor="reg-name" className="mb-1.5 block text-sm font-medium text-surface-700 dark:text-surface-300">
                Name
              </label>
              <input
                id="reg-name"
          ...
          <p className="mt-4 text-center text-sm text-surface-500 dark:text-surface-400">
            ...
            <Link to="/login" className="font-medium text-accent-500 hover:text-accent-600 dark:text-accent-400">
              Sign in
            </Link>
          </p>
        </form>
